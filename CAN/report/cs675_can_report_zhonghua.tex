...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \subfigure[peer1 joined]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide1.png}}
   \subfigure[peer2 joined]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide2.png}}
   \subfigure[peer3 joined]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide3.png}}
   \subfigure[peer1 left]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide4.png}}
   \subfigure[peer3 left, before self merging]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide5.png}}
   \subfigure[after self merging]{\includegraphics[width=1.8in, clip=true, trim=80mm 0mm 80mm 0mm]{figures/zone/Slide6.png}}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \subfigure[before peer3 left]{\includegraphics[width=5in, clip=true, trim=20mm 30mm 20mm 25mm]{figures/before.png}}
   \subfigure[after peer3 left]{\includegraphics[width=5in, clip=true, trim=20mm 30mm 20mm 25mm]{figures/after.png}}
